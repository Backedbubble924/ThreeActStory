...
#pragma warning disable 1591
    ...
    public static class WMS
    {
        ...
        public static readonly int _CameraDepthTextureHalfTexelSize = ID("_CameraDepthTextureHalf_TexelSize");
        public static readonly int _CameraDepthTextureQuarterTexelSize = ID("_CameraDepthTextureQuarter_TexelSize");
        public static readonly int _CameraDepthTextureEighthTexelSize = ID("_CameraDepthTextureEighth_TexelSize");
        public static readonly int _CameraDepthTextureHalfST = ID("_CameraDepthTextureHalf_ST");
        public static readonly int _CameraDepthTextureQuarterST = ID("_CameraDepthTextureQuarter_ST");
        public static readonly int _CameraDepthTextureEighthST = ID("_CameraDepthTextureEighth_ST");
        ...
        public static readonly int _ShadowMapTexture = ID("_ShadowMapTexture");
        ...
        public static readonly int _WeatherMakerShadowMapTexture = ID("_WeatherMakerShadowMapTexture");
        public static readonly int _WeatherMakerShadowMapTexture_TexelSize = ID("_WeatherMakerShadowMapTexture_TexelSize");
