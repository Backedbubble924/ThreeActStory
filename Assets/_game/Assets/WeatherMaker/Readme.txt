...
For URP Weather Maker requires Unity 6000 or newer and URP 17.3 or newer. HDRP is currently not supported.
...
Requirements
--------------------------------------------------
- URP requires URP 17.3 or newer on Unity 6000 or newer (Metal on MAC or D3D 12 on Windows). Other rendering modes untested and not supported.
...
- Must use Unity 6000 or newer with URP 17 or newer.
