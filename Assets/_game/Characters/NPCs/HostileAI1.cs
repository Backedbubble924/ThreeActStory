...
public class HostileAI1 : MonoBehaviour
{
    [Header("References")]
    ...
    private void FireProjectile()
    {
        ...
        Rigidbody projectileInstance = Instantiate(projectilePrefab, firePoint.position, firePoint.rotation).GetComponent<Rigidbody>();
